...
| 环节 | 技能 | 描述 |
|------|------|------|
| 🔍 代码审计 | `security-audit` | OWASP Top 10 代码安全审计，发现注入/XSS/SSRF 等漏洞 |
| 🔑 密钥检测 | `secret-scanner` | 检测代码中泄露的 API Key、Token、密码、证书 |
| 📦 依赖扫描 | `dependency-audit` | npm/pip/cargo 依赖漏洞扫描与修复方案 |
| 🔐 认证审查 | `auth-review` | 认证/授权流程审查，Session/JWT/OAuth 安全检查 |
